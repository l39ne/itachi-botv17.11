...
if (limitCounts <= 0) return Lxa.sendMessage(from, `*Lo siento ${pushname} Agotaste tus diamantes ♦️*\n*Puedes comprar más Diamantes con *${prefix}buydiamond* O  Contáctenos para ser usuario premium`, text,{ quoted: mek})
Lxa.sendMessage(from, `╭◪ *「 DIAMANTES 」*
╰───────────────╮ 
╭───────────────╯
├❏ *♦️Diamantes* : ${limitCounts} ♦️
╰───────────────╯
*NOTA* : Al agotar tus Diamantes, Puedes subir de nivel para conseguir Diamantes o comprar con *${prefix}buydiamond*`, text, { quoted : mek})
      found = true
      }
    }
if (found === false) {
