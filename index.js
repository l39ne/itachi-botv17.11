...
El resto de tus Diamantes : ${limitCounts}
...
await reply(`〘  *TRANSFERENCIA*  〙
  La transferencia de BotCoin se realizó correctamente
  ‣ *De* : ${sender.split("@")[0]}
  ‣ *A* : ${tujuan}
